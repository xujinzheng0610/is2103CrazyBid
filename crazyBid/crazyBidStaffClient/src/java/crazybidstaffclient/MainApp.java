...
public class MainApp {
    ...
    public void doLogin() throws InvalidLoginCredentialException {
        ...
        System.out.println("*** CrazyBid.com Staff System :: Login ***\n");
        System.out.print("Enter username> ");
        username = scanner.nextLine().trim();
        System.out.print("Enter password> ");
        password = scanner.nextLine().trim();

        if (username.length() > 0 && password.length() > 0) { //login validation
            try {
    ...
    public void menuMain() throws StaffNotFoundException {
        ...
        int response = 0;
        while (true) {
            System.out.println("*** CrazyBid.com Staff System :: Main Menu   ***\n");
        ...
        while (true) {
            ...
            if (scanner.nextLine().trim().equals(currentStaff.getPassword())) {
                while (true) {
                    ...
                    while (newPassword.length() == 0) { //validate empty input
