...
public class FinanceStaffOperationModule {
    ...
    public void menuFinanceStaffOperation() throws InvalidAccessRightException {
        if (currentStaff.getAccessRight() != StaffAccessRight.FINANCE) {
            throw new InvalidAccessRightException("You don't have FINANCE rights to access the finance system!");
        }
        Scanner scanner = new Scanner(System.in);
        Integer response = 0;

        while (true) {
            System.out.println("*** Crazy Bid : Finance System ***\n");
...
//            System.out.println("4: Delete Credit Package");
    ...
    public void createCreditPackage() {
        ...
        System.out.println("*** Crazy Bid:: Finance System :: Create New Credit Package ***\n");
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("This Package has already been created! Please Try again! ");
                ...
                newCreditPackage.setPackageName(packageName);
    ...
    public void viewCreditPackageDetails() {
        ...
        System.out.println("*** CrazyBid :: Finance System  :: View Credit Package Details ***\n");
    ...
    public void doUpdateCreditPackage(CreditPackage c) {
        ...
        System.out.println("*** Crazy Bid :: Finance System  :: View Credit Package Details :: Update Package ***\n");
    ...
    public void doDeleteCreditPackage(CreditPackage c) {
        ...
        if (c.getSoldAmount() > 0) {
            ...
            String input;
            System.out.println("*** Crazy Bid :: Finance System  :: View Credit package Details :: Delete Package ***\n");
